...
Esta página é a vitrine principal do produto e conta com as seguintes seções interativas:
...
Esta página possui duas visões baseadas em estado React:
...
Simula o ecossistema pós-compra do cliente:
